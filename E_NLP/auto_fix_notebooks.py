...
def fix_notebook(notebook_path):
    ...
    if first_code_idx + 1 < len(notebook['cells']):
        ...
        if 'ENVIRONMENT DETECTION' in ''.join(next_cell.get('source', [])):
            print("  ⚠️ Environment setup already exists, skipping cell insertion")
    ...
    if not env_setup_exists:
        ...
        print("  ✅ Added environment setup cells")
    ...
    print(f"  ✅ Updated {paths_updated} cells with new file paths")
...
def main():
    ...
    print("\n" + "=" * 80)
    print(f"\n✅ Successfully fixed {success_count}/{len(notebooks_to_fix)} notebooks!")
    print("\n📋 Summary:")
